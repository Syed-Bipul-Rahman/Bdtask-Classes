package com.bdtask.mvp_retrofit.Adapter;
...
import com.bdtask.mvp_retrofit.R;
import com.bdtask.mvp_retrofit.View.Details;
...
public class AllProductsAdapter extends RecyclerView.Adapter<AllProductsAdapter.ViewHolder> {
    ...
    public AllProductsAdapter(Activity activity, ArrayList<ResponseObject> myListData) {
        listdata = myListData;
